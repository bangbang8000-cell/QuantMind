...
from tradingagents.agents.utils.agent_utils import build_instrument_context, get_language_instruction, get_news, get_rss_news
...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "\n\n请使用以下工具获取公司相关新闻和市场讨论："
            "\n- `get_news(query, start_date, end_date)`：获取公司个股新闻"
            "\n- `get_rss_news(ticker, company_name)`：搜索 RSS 新闻源（华尔街见闻/东方财富/财新/第一财经），按关键词匹配公司和行业相关新闻"
            "\n从新闻内容中推断市场情绪方向、强度和可能的转折点。"
